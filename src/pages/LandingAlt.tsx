                ...
                <div className="relative overflow-hidden bg-background pt-48 pb-24">
                    <div className="absolute inset-0 z-0">
                        ...
                        <div className="absolute top-0 right-0 -translate-y-1/4 translate-x-1/4 transform">
                            <div className="h-96 w-96 rounded-full bg-primary-200/30 blur-3xl dark:bg-primary-900/20" />
                        </div>
                        <div className="absolute bottom-0 left-0 translate-y-1/4 -translate-x-1/4 transform">
                            <div className="h-96 w-96 rounded-full bg-secondary-200/30 blur-3xl dark:bg-secondary-900/20" />
                        </div>
                    </div>
                        ...
                        <div className="lg:grid lg:grid-cols-12 lg:gap-8">
                            <div className="sm:text-center md:mx-auto md:max-w-2xl lg:col-span-6 lg:text-left">
                                <h1 className="text-4xl font-bold tracking-tight sm:text-5xl md:text-6xl">
                                    ...
                                    <span className="block text-primary">Godot Engine Assistant</span>
                                </h1>
                                <p className="mt-6 text-lg text-foreground-500">
                                    Get instant answers to your Godot Engine questions with our specialized AI assistant.
                            ...
                            <div className="mt-16 sm:mt-24 lg:col-span-6 lg:mt-0">
                                <div className="bg-content1 shadow-lg rounded-lg overflow-hidden border border-divider">
                                    <div className="bg-content2 px-4 py-3 border-b border-divider flex items-center">
                                        ...
                                        <div className="mx-auto text-xs text-foreground-500">Godot Assistant</div>
                                    </div>
                                    <div className="p-4 space-y-4">
                                        ...
                                        <div className="flex items-start gap-3">
                                            <div className="flex-shrink-0 bg-secondary-100 dark:bg-secondary-900/30 p-2 rounded-md">
                                                <Icon icon="logos:godot-icon" width={20} />
                                            </div>
                                            <div className="bg-content2 rounded-lg p-3 text-sm">
                                                <p className="mb-2">Here's a basic 2D character controller for Godot 4:</p>
...
func _physics_process(delta):
    ...
    move_and_slide()`}
                                                ...
                                                <p className="mt-2">This code handles basic movement, jumping, and gravity for a 2D character.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div id="features" className="py-16 bg-content1">
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="text-center mb-12">
                            <h2 className="text-3xl font-bold mb-4">Supercharge Your Godot Development</h2>
                            <p className="text-foreground-500 max-w-2xl mx-auto">
                                Our AI assistant is specifically trained on Godot Engine to help you build games and applications faster.
                            </p>
                        </div>
                            ...
                            {[
                                {
                                    ...
                                    description: "Access the entire Godot documentation with natural language queries. Get precise answers from the official docs."
                                },
                                {
                                    icon: "lucide:globe",
                                    title: "Web Knowledge",
                                    description: "When documentation isn't enough, our assistant searches the web, including Reddit, GitHub, and forums for solutions."
                                },
                                {
                                    icon: "lucide:code",
                                    title: "Code Generation",
                                    description: "Get ready-to-use code snippets and examples that you can directly implement in your Godot projects."
                                },
                                {
                                    icon: "lucide:settings",
                                    title: "Customizable Models",
                                    description: "Choose from different AI models and adjust parameters like temperature to get responses that match your needs."
                                },
                                {
                                    icon: "lucide:palette",
                                    title: "Theme Customization",
                                    description: "Personalize the UI with different themes and layouts to match your preferences and workflow."
                                },
                                {
                                    icon: "lucide:layers",
                                    title: "Session Management",
                                    description: "Create, save, and continue chat sessions. Organize your conversations by project or topic."
                                }
                            ].map((feature, index) => (
                                <Card key={index} className="border border-divider">
                                    <CardBody className="p-6">
                                        <div className="bg-primary-100 dark:bg-primary-900/30 p-3 rounded-md w-fit mb-4">
                ...
                <div className="max-w-7xl mx-auto px-4 py-16 sm:px-6 lg:px-8">
                    <div className="text-center mb-12">
                        <h2 className="text-3xl font-bold mb-4">Experience the Power of Godot Assistant</h2>
                        <p className="text-foreground-500 max-w-2xl mx-auto">
                            See how our AI-powered assistant can help you with Godot development.
                        </p>
                    </div>
                        ...
                        {[
                            {
                                ...
                                description: "Ask questions about Godot Engine and get instant answers with code examples and explanations."
                            },
                            {
                                icon: "lucide:settings",
                                title: "Model Selection",
                                description: "Choose from different AI models and adjust parameters to get responses that match your needs."
                            },
                            {
                                icon: "lucide:moon",
                                title: "Theme Switching",
                                description: "Switch between light and dark themes to match your preferences and reduce eye strain."
                            },
                            {
                                icon: "lucide:layers",
                                title: "Session Management",
                            ...
                            <Card key={index} className="border border-divider">
                                <CardBody className="p-6">
                                    <div className="bg-primary-100 dark:bg-primary-900/30 p-3 rounded-md w-fit mb-4">
                                        <Icon icon={item.icon} className="text-primary" width={24} />
                                    </div>
                ...
                <div className="bg-content2 py-16">
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                        <h2 className="text-3xl font-bold mb-6">Ready to Accelerate Your Godot Development?</h2>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex flex-col items-center text-center">
                        ...
                        <p className="text-foreground-500 max-w-md mb-6">
                            Your AI-powered companion for Godot Engine development. Get answers, code examples, and solutions instantly.
                        </p>
                        <div className="flex gap-6">
                            <Link href="#" aria-label="Twitter" className="text-foreground-500 hover:text-primary transition-colors">
                                <Icon icon="lucide:twitter" width={24} />
                            </Link>
                            <Link href="#" aria-label="GitHub" className="text-foreground-500 hover:text-primary transition-colors">
                                <Icon icon="lucide:github" width={24} />
                            </Link>
                            <Link href="#" aria-label="Discord" className="text-foreground-500 hover:text-primary transition-colors">
